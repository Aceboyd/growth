  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
        <h2 className="text-2xl font-bold text-white mb-2">Deposit & Withdraw</h2>
        <p className="text-gray-300">Manage your cryptocurrency deposits and withdrawals</p>
      </div>
            ...
            <div className="space-y-6">
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-blue-400 font-medium">Deposit Information</span>
                </div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    readOnly
                    className="flex-1 bg-gray-700/50 border border-gray-600 rounded-lg px-4 py-3 text-white font-mono text-sm"
                  />
                  <button
                  ...
                  <button
                    ...
                    className="p-3 bg-purple-500 hover:bg-purple-600 rounded-lg text-white transition-colors"
                  >
              ...
              {showQR && (
                <div className="bg-gray-700/50 border border-gray-600 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-300 text-sm">Scan this QR code to get the deposit address</p>
                </div>
              )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-red-400 font-medium">Withdrawal Information</span>
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-gray-700/50 border border-gray-600 rounded-lg px-4 py-3 pr-16 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="0.00"
                    step="0.00000001"
                    required
                  />
              ...
              <div className="flex items-center space-x-4">
                <button
                  type="submit"
                  className="flex-1 bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white font-medium py-3 px-6 rounded-lg transition-all"
                >
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
          ...
          <div className="space-y-3">
            {recentTransactions.map((transaction) => (
              <div key={transaction.id} className="bg-gray-700/30 border border-gray-600/50 rounded-lg p-4">
